...
class UserControllerTest extends WebTestCase
{
    ...
    public function testCreateUserByAdmin(): void
    {
        ...
        $form['user[email]'] = 'newuser5@example.com';
        ...
        $createdUser = $userRepository->findOneBy(['username' => 'newuser5']);
        $this->assertNotNull($createdUser);
        $this->assertSame('newuser5', $createdUser->getUsername());
        $this->assertSame('newuser5@example.com', $createdUser->getEmail());
