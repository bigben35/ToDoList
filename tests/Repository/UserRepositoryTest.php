...
{
    $user = $this->userRepository->findOneBy(['username' => 'testuser5']);
    ...
    $this->assertNull($this->userRepository->findOneBy(['username' => 'testuser5']));
}
    ...
    public function testAddTask(): void
    {
        ...
        $user->setEmail('testuser14@example.com');
...
public function testUpgradePassword(): void
{
    ...
    $user->setEmail('testuser13@example.com');
